...
For that, **Squall** provides a `jsonable_encoder()` function.
...
!!! note
    `jsonable_encoder` is actually used by **Squall** internally to convert data. But it is useful in many other scenarios.
