...
@app.router.get("/query/int")
def get_query_type(query: int):
    return f"foo bar {query}"


@app.router.get("/query/int/optional")
...
@app.router.get("/query/int/default")
def get_query_type_int_default(query: int = 10):
    return f"foo bar {query}"


@app.router.get("/query/param")
...
@app.router.get("/query/param-required")
def get_query_param_required(query=Query(...)):
    return f"foo bar {query}"


@app.router.get("/query/param-required/int")
def get_query_param_required_type(query: int = Query(...)):
    return f"foo bar {query}"


@app.router.get("/enum-status-code", status_code=http.HTTPStatus.CREATED)
